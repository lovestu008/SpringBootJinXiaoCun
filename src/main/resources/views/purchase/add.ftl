...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        <div class="layui-input-block">
            <button class="layui-btn layui-btn-lg layui-bg-red" lay-submit=""  lay-filter="addPurchase">确认</button>
            <button class="layui-btn layui-btn-lg layui-btn-normal layui-bg-orange" id="closeBtn">取消</button><#--记得一定要写id属性值-->
        </div>
    </div>
</form>
<script type="text/javascript" src="${ctx}/js/purchase/add.js"></script>
</body>
</html>